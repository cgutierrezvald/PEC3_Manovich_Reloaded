...
<p align="center">
  <img width=600 height=500 src="https://live.staticflickr.com/4044/4631590253_81d60a0169_k.jpg">
</p>
...
Entendiendo el libro **El software toma el Mando de Lev Manovich** devemos entender el término hibridación no como una suma de 
partes sino como el resultado de la unión de medios y posterior creación a partir de ellos de uno nuevo que puda aportar
lo que contenián cada una de las partes y elementos nuevos.

En el texto se hace muchas alegoría al mundo cinematrográfico y a cómo se han producico híbridos un ejemplo de ello es 
*The Invisible Shape of Things Past*, un conocido proyecto de patrimonio cultural digital sobre la historia de Berlín 
elaborado por *Joachim Sauter* y *Dirk Lüsebrink* desde una conocida empresa de medios llamada Art+Com entre 1995 y 2007.

> La antigua estructura ha sido cartografiada de nuevo hasta formar una nueva.
> Esta nueva estructura conserva los datos > originales y su relación, es decir,
> los fotogramas originales de la película siguen organizados de manera secuencial.
> Pero también cuenta con unas nuevas dimensiones: el tamaño de los fotogramas y
> sus bordes. La nueva estructura también > posibilita un nuevo tipo de interfaz
> para el acceso a la película que combina los atributos del espacio virtual con los
> cinematográficos. - Lev Manovich

Por lo tanto, y volviendo al mundo cinematrográfico, gracias a la integración de distintos medios en un mismo proyecto
somos capaces de crear por ejemplo efectos visuales de texto que se entrelazan con las imágenes grabadas del mundo real
creando así un nuevo medio que integra las propiedades de los textos, la fuente, tamaño, etc y las propiedades de las imágenes,
...
Y con esto ya doy paso a mi dos ejemplos de hibridación, por un lado un asistente virtual que te permite mantener en perfecta condiciones tus plantaciones mediante el uso de la cámara y por otro lado el mundo Tron, desde la palícula hasta el videojuego.

# Caso de estudio: PlantixApp - Tu jardinero virtual
![PlantixApp](https://github.com/cgutierrezvald/PEC3_Manovich_Reloaded/blob/main/PlantixAppPortada.PNG "PlantixApp")
> Plantix ayuda a los agricultores a diagnosticar y tratar lo problemas de sus cultivos, mejorar la productividad y brindar conocimientos agrícolas.

Este texto es la carta de presentación de la aplicación, ahora voy a ver un poco más lo que nos ofrecen.

### Diagnóstico de enfermedades
Nos indican que tomando una foto podemos diagnosticar los posibles problemas que tengan nuestras plantas, en este caso la hibridación se está realizando gracias a que tomando una foto de algo que pertenece al mundo real, un software es capaz de identificar posibles problemas en dicho elemento, es decir en nuestro cultivo, evidentemente gracias a la integración de distintos elementos, uno meramente físico que es la toma de la foto y después la utilización de un software de reconocimiento de imágenes conectado a una base de datos se consigue averiguar la enfermedad del cultivo, antiguamente, si no se hacía mediante la observación directa del experto no se podía.
...
También tiene una amplia base de datos sobre cultivos, consejos y trucos. En este caso la hibridación es más simple o menos novedosa, dado que es algo que ofrecen la mayoría de las webs o aplicaciones de la materia, pero no deja de ser un añadido a la hibridación entre una App y la base de conociento que podríamos adquirir por ejemplo yendo a un experto en la materia o a una biblioteca especializada.

![PlantixApp](https://github.com/cgutierrezvald/PEC3_Manovich_Reloaded/blob/main/PlantixBiblioteca.PNG "PlantixApp")

Bajo mi punto de vista es un ejemplo de hibridación en el que se ha integrado distintos elementos, por un lado tomar una foto del cultivo, luego el envío del mismo a la aplicación y por medio de un software que por sí solo no hace nada se logran entrelazar los otros medios y se consigue un diagnóstico de la planta que está en la foto, en su libro Manovich indica que la hibridación no es una suma 1 + 1 sino que la integación de distintos medios dan como resultado un nuevo medio con más propiedades que los propios medios que se integran y que de otra forma no se hubiera podido conseguir, y esto es lo que hace la aplicación al procesar mediante el uso de un software específico, *la softwarización de la que habla Manovich en su libro*, la foto que tomamos de nuestros cultivos para diagnosticar su dolencia.
...
Como indica en el texto anteriomente citado, esta película fue una de la primeras en integrar imagenes reales e imágenes generadas por ordenador por lo que para mi es un claro ejemplo de hibridación, entre el mundo real, filmado como se hace en las películas de toda la vida y luego un proceso de postproducción en el que se integran imágenes generadas por ordenador, dando lugar a un nuevo medio que contine el resultado de los dos medios anteriores, *no uno junto al otro o uno después de otro sino ambos al mismo tiempo de la mano como un nuevo medio fruto de la hibridación de los dos anteriores*. La hibridación radica en este caso no en la película en sí, sino en la forma en la que con el uso del software se realiza una producción distinta a como se venía haciendo hasta ahora. Utilizando parte de los medios físicos y medios digitales para lograr un nuevo lenguaje audiovisual, que en parte, y según Manovich, la hibridación como en la biología radica en la creación de una nueva especie y en este caso la nueva especie es la producción de cine haciendo uso de croma, integrando medios reales y digitales de tal forma que den fruto a un nuevo elemento cinematográfico.

Porteriormente a la película salieron varios juegos de la saga Tron, que pretenden también hacer un integración entre el mundo real y la virtualización del juego de la película original mostrando así otro modo de hibridación, esta vez ente el mundo real, por ser una aventura gráfica de acción y el mungo de la ficción, de los videojuegos integrando lo mejor de ambos mundos en un viedeojuego inmersivo que nos traslada al mundo idílico de **Tron**, la película original. Además, este tipo de juegos tienen modo multijugador, lo que le da otro nivel a la hibridación, dado que en el mundo real podemos hacer carreras de motos, o de bici en mi caso, y gracias a los modos multijugador podemos hacer esta misma acción en el mundo virtual.
...
> Poco a poco son más las películas que incluyen estéticas altamente estilizadas que anteriormente hubiéramos identificado con la ilustración y no con la creación cinematográfica.
