...
Como indica en el texto anteriomente citado, esta película fue una de la primeras en integrar imagenes reales e imágeness generadas por ordenador por lo que para mi es un claro ejemplo de hibridación, entre el mundo real, filmado como se hace en las películas de toda la fica y luego un proceso de postproducción en el que se integran imágense generadas por ordenador, dando lugar a un nuevo medio que contine el resultado de los dos medios anteriores, *no uno junto al otro o uno después de otro* sino ambos al mismo tiempo de la mano como un nuevo medio fruto de la hibridación de los dos anteriores.
